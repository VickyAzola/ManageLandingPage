    ...
    return (
        <>
            <div className='flex items-center justify-between px-2 lg:px-0 lg:gap-x-3' >
                ...
                >
                    <svg className="fill-white hover:fill-BrightRed w-8 h-8 lg:w-5 lg:h-5 transition-colors"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" role="img" aria-hidden="true">
                ...
                >
                    <svg className="fill-white hover:fill-BrightRed w-8 h-8 lg:w-5 lg:h-5 transition-colors"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" role="img" aria-hidden="true">
                ...
                <a 
                    ...
                    rel="noopener noreferrer"
                >
                    <svg className="fill-white hover:fill-BrightRed w-9 h-9 lg:w-5 lg:h-5 transition-colors"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" role="img" aria-hidden="true">
