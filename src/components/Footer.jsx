...
function Footer() {
    ...
    <div className='lg:grid lg:grid-cols-3 lg:gap-x-8'>
        ...
        <div className='lg:order-last lg:flex lg:flex-col lg:justify-between lg:items-end'>
            <Form />
            <p className='hidden lg:block mt-14 lg:mt-0 text-xs text-DarkGrayishBlue'>Copyright 2020. All Rights Reserved</p>
        </div>

        <nav id="bottomNav" aria-label="Footer Navigation" className='flex justify-between px-6 lg:px-0 text-sm my-10 lg:my-0 text-VaryLightGray'>
            <ul className='flex flex-col gap-y-2.5'>
            {footerNav1.map((item, index) => (
                <li key={index} className='hover:text-BrightRed'>
                    <a href="#" aria-label={`Go to ${item.text} page`}>{item.text} </a>
                </li>
            ))}
            </ul>
            <ul className='flex flex-col gap-y-2.5'>
        ...
        <div className='lg:order-first lg:flex lg:flex-col lg:justify-between lg:items-start'>
            ...
            <p className='lg:hidden mt-14 lg:mt-0 text-xs text-center text-DarkGrayishBlue'>Copyright 2020. All Rights Reserved</p>
        </div>
    </div>
    </>
    )
